...
CREATE TABLE `posts` (`id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '기본 키',
                      `user_id` int unsigned NOT NULL COMMENT '작성자. users 테이블의 레코드 ID',
                      ...
                      PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=61229 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
